  ...
  public function content() {
    ...
    foreach ($data as $user_values1) {
      try {
        ...
        // ✅ Custom fields
        $user->set('field_business_name', $user_values1->field_business_name ?? '');
        $user->set('field_first_name_consultant_', $user_values1->field_first_name_consultant_ ?? '');
        $user->set('field_last_name_consultant_', $user_values1->field_last_name_consultant_ ?? '');
